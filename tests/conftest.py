...
# WARNING: Ensure imports from `ainpc_prototype` comes after this line
from ainpc_prototype import app, settings, db  # noqa
from ainpc_prototype.cli import create_user, cli  # noqa
