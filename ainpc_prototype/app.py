...
description = """
ainpc_prototype API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="ainpc_prototype",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://ainpc_prototype.com/terms/",
    contact={
        "name": "jakepyo",
        "url": "http://ainpc_prototype.com/contact/",
        "email": "jakepyo@ainpc_prototype.com",
    },
    license_info={
        "name": "The Unlicense",
